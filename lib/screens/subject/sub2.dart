...
class User {
  ...
  static List<User> getUsers() {
    return <User>[
      User(Name: "القضايا الاجتماعيه الاخلاقيه", code: "HU 102"),
      User(Name: "حقوق الانسان", code: "BS 100"),
      User(Name: "الرياضيات 2", code: "BS 102"),
...
class DataTableDemoState extends State<DataTableDemo2> {
